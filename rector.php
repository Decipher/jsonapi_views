...
return RectorConfig::configure()
  ->withSkip([
    ...
    // D10's core stubs return User|false from drupalCreateUser()/createUser(),
    // needing the instanceof narrowing this module uses for cross-version
    // compatibility; D11's stubs already narrow it, making Rector see the
    // assert as dead code there. Removing it would break D10's PHPStan run.
    RemoveDeadInstanceOfAssertRector::class,
    // D10 runs on PHPUnit 10, which lacks the attribute classes these two
    // rules would introduce (PHPUnit 11, used by D11, has them) - converting
    // would break PHPStan on D10 with "Attribute class does not exist".
